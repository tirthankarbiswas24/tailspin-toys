...
The repository's [coding standards](.github/instructions/coding-standards.instructions.md) define how to write comments and documentation, including TSDoc for exported data-layer functions and documented `Props` interfaces for reusable Astro components. Comments should explain intent and decisions rather than restate code, and TypeScript formatting is enforced by ESLint.
